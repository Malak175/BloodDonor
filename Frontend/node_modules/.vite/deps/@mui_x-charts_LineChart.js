import {
  reactMajor_default
} from "./chunk-SXJCEGNM.js";
import {
  ChartsText,
  getStringSize,
  getWordsByLines,
  useIsHydrated
} from "./chunk-45BWGQIZ.js";
import {
  ChartDataProvider,
  ChartsLegend,
  ChartsOverlay,
...
} from "./chunk-O7GGCU6N.js";
import "./chunk-THS7PHQB.js";
import "./chunk-SW4BYMYY.js";
import {
  useSlotProps_default
} from "./chunk-ESKRWHBP.js";
import "./chunk-5WHKERO6.js";
...
function useTicks(options) {
  ...
  return React13.useMemo(() => getTicks({
    scale,
    tickNumber,
    tickPlacement,
    tickInterval,
  ...
  return (0, import_jsx_runtime11.jsx)(React15.Fragment, {
    children: xTicks.map((item, index) => {
      ...
      return (0, import_jsx_runtime11.jsxs)("g", {
        ...
        }, slotProps?.axisTick)), tickLabel !== void 0 && showTickLabel && (0, import_jsx_runtime11.jsx)(TickLabel, _extends({
          x: xTickLabel,
          y: yTickLabel
        }, axisTickLabelProps, {
          text: tickLabel
  ...
  return (0, import_jsx_runtime12.jsx)(React17.Fragment, {
    children: xTicks.map((item, index) => {
      ...
      return (0, import_jsx_runtime12.jsxs)("g", {
        ...
        children: [!disableTicks && !ignoreTick && showTick && (0, import_jsx_runtime12.jsx)(Tick, _extends({
          y2: tickYSize,
          className: classes.tick
        }, slotProps?.axisTick)), tickLabel !== void 0 && (0, import_jsx_runtime12.jsx)(TickLabel, _extends({
          x: xTickLabel,
          y: labelPositionY
        }, axisTickLabelProps, {
...
function ChartsXAxisImpl(_ref) {
  ...
  if (!skipTickRendering) {
    children = "groups" in axis && Array.isArray(axis.groups) ? (0, import_jsx_runtime13.jsx)(ChartsGroupedXAxisTicks, _extends({}, inProps)) : (0, import_jsx_runtime13.jsx)(ChartsSingleXAxisTicks, _extends({}, inProps, {
  ...
  return (0, import_jsx_runtime13.jsxs)(XAxisRoot, {
    ...
    }, slotProps?.axisLine)), children, label && (0, import_jsx_runtime13.jsx)("g", {
...
function ChartsXAxis(inProps) {
  ...
  return (0, import_jsx_runtime14.jsx)(ChartsXAxisImpl, _extends({}, inProps, {
    axis
  }));
}
true ? ChartsXAxis.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "pnpm proptypes"  |
  // ----------------------------------------------------------------------
  axis: import_prop_types10.default.oneOf(["x"]),
  /**
   ...
   * @default 4
   */
  tickLabelMinGap: import_prop_types10.default.number,
  /**
    ...
    children: yTicks.map((item, index) => {
      ...
      return (0, import_jsx_runtime15.jsxs)("g", {
        ...
        children: [!disableTicks && (0, import_jsx_runtime15.jsx)(Tick, _extends({
          ...
          className: classes.tick
        }, slotProps?.axisTick)), tickLabel !== void 0 && !skipLabel && (0, import_jsx_runtime15.jsx)(TickLabel, _extends({
          x: xTickLabel,
          y: yTickLabel,
          text: tickLabel
        }, axisTickLabelProps))]
  ...
  return (0, import_jsx_runtime16.jsx)(React21.Fragment, {
    children: yTicks.map((item, index) => {
      ...
      return (0, import_jsx_runtime16.jsxs)("g", {
        ...
        className: classes.tickContainer,
        "data-group-index": groupIndex,
        children: [!disableTicks && !ignoreTick && showTick && (0, import_jsx_runtime16.jsx)(Tick, _extends({
          x2: tickXSize,
          className: classes.tick
        }, slotProps?.axisTick)), tickLabel !== void 0 && (0, import_jsx_runtime16.jsx)(TickLabel, _extends({
          x: labelPositionX,
          y: yTickLabel
        }, axisTickLabelProps, {
          style: _extends({}, axisTickLabelProps.style, groupConfig.tickLabelStyle),
...
function ChartsYAxisImpl(_ref) {
  ...
  let children = null;
  if (!skipTickRendering) {
    children = "groups" in axis && Array.isArray(axis.groups) ? (0, import_jsx_runtime17.jsx)(ChartsGroupedYAxisTicks, _extends({}, inProps)) : (0, import_jsx_runtime17.jsx)(ChartsSingleYAxisTicks, _extends({}, inProps, {
      axisLabelHeight
    }));
  }
  return (0, import_jsx_runtime17.jsxs)(YAxisRoot, {
    ...
    children: [!disableLine && (0, import_jsx_runtime17.jsx)(Line, _extends({
      ...
      y2: top + height,
      className: classes.line
    }, lineProps)), children, label && isHydrated && (0, import_jsx_runtime17.jsx)("g", {
      className: classes.label,
...
function ChartsYAxis(inProps) {
  ...
  return (0, import_jsx_runtime18.jsx)(ChartsYAxisImpl, _extends({}, inProps, {
    axis
  }));
}
true ? ChartsYAxis.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "pnpm proptypes"  |
  // ----------------------------------------------------------------------
  axis: import_prop_types11.default.oneOf(["y"]),
  /**
   * The id of the axis to render.
   * If undefined, it will be the first defined axis.
   */
...
function ChartsAxis(props) {
  ...
  return (0, import_jsx_runtime19.jsxs)(React24.Fragment, {
    children: [xAxisIds.map((axisId) => {
      ...
      return (0, import_jsx_runtime19.jsx)(ChartsXAxis, {
        slots,
        slotProps,
        axisId
      }, axisId);
      ...
      return (0, import_jsx_runtime19.jsx)(ChartsYAxis, {
        slots,
        slotProps,
        axisId
      }, axisId);
...
function ChartsYHighlight(props) {
  ...
  return axisYValues.map(({
    ...
    return (0, import_jsx_runtime20.jsxs)(React25.Fragment, {
      children: [isYScaleOrdinal && yScale(value) !== void 0 && (0, import_jsx_runtime20.jsx)(ChartsAxisHighlightPath, {
        d: `M ${left} ${yScale(value) - (yScale.step() - yScale.bandwidth()) / 2} l 0 ${yScale.step()} l ${width} 0 l 0 ${-yScale.step()} Z`,
        className: classes.root,
        ownerState: {
          axisHighlight: "band"
        }
      }), type === "line" && value !== null && (0, import_jsx_runtime20.jsx)(ChartsAxisHighlightPath, {
...
function ChartsXHighlight(props) {
  ...
  return axisXValues.map(({
    ...
    return (0, import_jsx_runtime21.jsxs)(React26.Fragment, {
      children: [isXScaleOrdinal && xScale(value) !== void 0 && (0, import_jsx_runtime21.jsx)(ChartsAxisHighlightPath, {
        d: `M ${xScale(value) - (xScale.step() - xScale.bandwidth()) / 2} ${top} l ${xScale.step()} 0 l 0 ${height} l ${-xScale.step()} 0 Z`,
        className: classes.root,
        ownerState: {
          axisHighlight: "band"
        }
      }), type === "line" && value !== null && (0, import_jsx_runtime21.jsx)(ChartsAxisHighlightPath, {
...
function ChartsAxisHighlight(props) {
  ...
  return (0, import_jsx_runtime22.jsxs)(React27.Fragment, {
    children: [xAxisHighlight && xAxisHighlight !== "none" && (0, import_jsx_runtime22.jsx)(ChartsXHighlight, {
      type: xAxisHighlight,
      classes
    }), yAxisHighlight && yAxisHighlight !== "none" && (0, import_jsx_runtime22.jsx)(ChartsYHighlight, {
      type: yAxisHighlight,
      classes
    })]
  });
...
function ChartsClipPath(props) {
  ...
  return (0, import_jsx_runtime23.jsx)("clipPath", {
    id,
...
true ? ChartsClipPath.propTypes = {
   ...
   */
  offset: import_prop_types14.default.shape({
...
var _excluded14 = ["x", "y", "id", "classes", "color", "shape"];
...
true ? LineHighlightElement.propTypes = {
  ...
  shape: import_prop_types15.default.oneOf(["circle", "cross", "diamond", "square", "star", "triangle", "wye"]).isRequired
} : void 0;
...
function LineHighlightPlot(props) {
  ...
  return (0, import_jsx_runtime25.jsx)("g", _extends({}, other, {
    children: highlightedIndexes.flatMap(({
      ...
      return groupIds.flatMap((seriesId) => {
        ...
        const colorGetter = getColor_default(series[seriesId], xAxis[xAxisId], yAxis[yAxisId]);
        return (0, import_jsx_runtime25.jsx)(Element, _extends({
          id: seriesId,
...
function ChartsGridVertical(props) {
  ...
  return (0, import_jsx_runtime26.jsx)(React31.Fragment, {
    children: xTicks.map(({
      value,
      offset
    }) => (0, import_jsx_runtime26.jsx)(GridLine, {
      y1: start,
      y2: end,
      x1: offset,
      x2: offset,
...
function ChartsGridHorizontal(props) {
  ...
  return (0, import_jsx_runtime27.jsx)(React32.Fragment, {
    children: yTicks.map(({
      value,
      offset
    }) => (0, import_jsx_runtime27.jsx)(GridLine, {
      y1: offset,
      y2: offset,
      x1: start,
      x2: end,
...
var LINE_CHART_PLUGINS = [useChartZAxis, useChartCartesianAxis, useChartInteraction, useChartHighlight, useChartKeyboardNavigation];

// node_modules/@mui/x-charts/esm/LineChart/useLineChartProps.js
var _excluded17 = ["xAxis", "yAxis", "series", "width", "height", "margin", "colors", "dataset", "sx", "onAreaClick", "onLineClick", "onMarkClick", "axisHighlight", "disableLineItemHighlight", "hideLegend", "grid", "children", "slots", "slotProps", "skipAnimation", "loading", "highlightedItem", "onHighlightChange", "className", "showToolbar"];
var useLineChartProps = (props) => {
  ...
  const seriesWithDefault = React34.useMemo(() => series.map((s) => _extends({
...
function FocusedMark() {
  ...
  return (0, import_jsx_runtime29.jsx)("rect", {
    fill: "none",
    stroke: (theme.vars ?? theme).palette.text.primary,
    strokeWidth: 2,
...
var LineChart = React36.forwardRef(function LineChart2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiLineChart"
  });
  ...
  return (0, import_jsx_runtime30.jsx)(ChartDataProvider, _extends({}, chartDataProviderProps, {
    children: (0, import_jsx_runtime30.jsxs)(ChartsWrapper, _extends({}, chartsWrapperProps, {
      children: [props.showToolbar && Toolbar ? (0, import_jsx_runtime30.jsx)(Toolbar, _extends({}, props.slotProps?.toolbar)) : null, !props.hideLegend && (0, import_jsx_runtime30.jsx)(ChartsLegend, _extends({}, legendProps)), (0, import_jsx_runtime30.jsxs)(ChartsSurface, _extends({}, chartsSurfaceProps, {
        children: [(0, import_jsx_runtime30.jsx)(ChartsGrid, _extends({}, gridProps)), (0, import_jsx_runtime30.jsxs)("g", _extends({}, clipPathGroupProps, {
          children: [(0, import_jsx_runtime30.jsx)(AreaPlot, _extends({}, areaPlotProps)), (0, import_jsx_runtime30.jsx)(LinePlot, _extends({}, linePlotProps)), (0, import_jsx_runtime30.jsx)(ChartsOverlay, _extends({}, overlayProps)), (0, import_jsx_runtime30.jsx)(ChartsAxisHighlight, _extends({}, axisHighlightProps))]
        })), (0, import_jsx_runtime30.jsx)(FocusedMark, {}), (0, import_jsx_runtime30.jsx)(ChartsAxis, _extends({}, chartsAxisProps)), (0, import_jsx_runtime30.jsx)("g", {
          "data-drawing-container": true,
          children: (0, import_jsx_runtime30.jsx)(MarkPlot, _extends({}, markPlotProps))
        }), (0, import_jsx_runtime30.jsx)(LineHighlightPlot, _extends({}, lineHighlightPlotProps)), (0, import_jsx_runtime30.jsx)(ChartsClipPath, _extends({}, clipPathProps)), children]
      })), !props.loading && (0, import_jsx_runtime30.jsx)(Tooltip, _extends({}, props.slotProps?.tooltip))]
    }))
  }));
});
...
true ? LineChart.propTypes = {
   ...
   */
  disableLineItemHighlight: import_prop_types18.default.bool,
  enableKeyboardNavigation: import_prop_types18.default.bool,
  /**
   * Options to enable features planned for the next major.
   */
  experimentalFeatures: import_prop_types18.default.shape({
    preferStrictDomainInLineCharts: import_prop_types18.default.bool
  }),
  /**
   * Option to display a cartesian grid in the background.
   */
  grid: import_prop_types18.default.shape({
   ...
   */
  highlightedAxis: import_prop_types18.default.arrayOf(import_prop_types18.default.shape({
    axisId: import_prop_types18.default.oneOfType([import_prop_types18.default.number, import_prop_types18.default.string]).isRequired,
   ...
   */
  onHighlightedAxisChange: import_prop_types18.default.func,
  /**
   * Callback fired when a line element is clicked.
   */
  onLineClick: import_prop_types18.default.func,
  /**
   ...
   */
  xAxis: import_prop_types18.default.arrayOf(import_prop_types18.default.oneOfType([import_prop_types18.default.shape({
    ...
    groups: import_prop_types18.default.arrayOf(import_prop_types18.default.shape({
      getValue: import_prop_types18.default.func.isRequired,
    ...
    constant: import_prop_types18.default.number,
    data: import_prop_types18.default.array,
    dataKey: import_prop_types18.default.string,
    disableLine: import_prop_types18.default.bool,
    disableTicks: import_prop_types18.default.bool,
    ...
    position: import_prop_types18.default.oneOf(["bottom", "none", "top"]),
    reverse: import_prop_types18.default.bool,
    scaleType: import_prop_types18.default.oneOf(["symlog"]),
    slotProps: import_prop_types18.default.object,
    slots: import_prop_types18.default.object,
    sx: import_prop_types18.default.oneOfType([import_prop_types18.default.arrayOf(import_prop_types18.default.oneOfType([import_prop_types18.default.func, import_prop_types18.default.object, import_prop_types18.default.bool])), import_prop_types18.default.func, import_prop_types18.default.object]),
    tickInterval: import_prop_types18.default.oneOfType([import_prop_types18.default.oneOf(["auto"]), import_prop_types18.default.array, import_prop_types18.default.func]),
    ...
    label: import_prop_types18.default.string,
    labelStyle: import_prop_types18.default.object,
    max: import_prop_types18.default.oneOfType([import_prop_types18.default.number, import_prop_types18.default.shape({
      valueOf: import_prop_types18.default.func.isRequired
    })]),
    min: import_prop_types18.default.oneOfType([import_prop_types18.default.number, import_prop_types18.default.shape({
      valueOf: import_prop_types18.default.func.isRequired
    })]),
    offset: import_prop_types18.default.number,
    position: import_prop_types18.default.oneOf(["bottom", "none", "top"]),
   ...
   * An array of [[AxisConfig]] objects.
   */
  yAxis: import_prop_types18.default.arrayOf(import_prop_types18.default.oneOfType([import_prop_types18.default.shape({
