...
var consumeSlots = (name, slotPropName, options, InComponent) => {
  ...
  return React10.forwardRef(ConsumeSlotsInternal);
};
...
true ? ChartDataProvider.propTypes = {
  ...
  experimentalFeatures: import_prop_types11.default.shape({
    preferStrictDomainInLineCharts: import_prop_types11.default.bool
  }),
  /**
...
var ToolbarContext = React22.createContext(void 0);
if (true) ToolbarContext.displayName = "ToolbarContext";
function useToolbarContext() {
  const context = React22.useContext(ToolbarContext);
  if (context === void 0) {
...
function ToolbarContextProvider({
  ...
  const [focusableItemId, setFocusableItemId] = React22.useState(null);
  const focusableItemIdRef = React22.useRef(focusableItemId);
  const [items, setItems] = React22.useState([]);
  const getSortedItems = React22.useCallback(() => items.sort(sortByDocumentPosition), [items]);
  const findEnabledItem = React22.useCallback((startIndex, step, wrap = true) => {
  ...
  const registerItem = React22.useCallback((id, itemRef) => {
  ...
  const onItemKeyDown = React22.useCallback((event) => {
    if (!focusableItemId) {
      return;
    }
    const sortedItems = getSortedItems();
  ...
  const onItemFocus = React22.useCallback((id) => {
    if (focusableItemId !== id) {
      setFocusableItemId(id);
    }
  }, [focusableItemId, setFocusableItemId]);
  const onItemDisabled = React22.useCallback((id) => {
    const sortedItems = getSortedItems();
...
function useRegisterToolbarButton(props, ref) {
  ...
  const previousDisabled = React23.useRef(disabled);
  React23.useEffect(() => {
  ...
  const previousAriaDisabled = React23.useRef(ariaDisabled);
  React23.useEffect(() => {
...
var Toolbar = React24.forwardRef(function Toolbar2(_ref, ref) {
  let {
    className,
    render
...
true ? Toolbar.propTypes = {
   ...
   */
  render: import_prop_types12.default.oneOfType([import_prop_types12.default.element, import_prop_types12.default.func])
} : void 0;
...
var ToolbarButton = React25.forwardRef(function ToolbarButton2(props, ref) {
  const {
    render
...
true ? ToolbarButton.propTypes = {
  ...
  size: import_prop_types13.default.oneOf(["large", "medium", "small"]),
...
true ? ChartsWrapper.propTypes = {
   ...
   * @default false
   */
  hideLegend: import_prop_types14.default.bool,
  /**
...
function useFocusedItem() {
  ...
  return React27.useMemo(() => focusedSeriesType === void 0 || focusedSeriesId === void 0 || focusedDataIndex === void 0 ? null : {
...
//# sourceMappingURL=chunk-YVTEWNN3.js.map
